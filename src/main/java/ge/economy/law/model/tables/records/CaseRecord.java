...
public class CaseRecord extends UpdatableRecordImpl<CaseRecord> implements Record15<Integer, String, String, Integer, String, Date, Integer, String, Integer, Date, String, String, Integer, Integer, Integer> {

	private static final long serialVersionUID = -1191386539;
	...
	/**
	 * Setter for <code>public.case.judge_assistant_phone</code>.
	 */
	public void setJudgeAssistantPhone(String value) {
		setValue(4, value);
	}

	/**
	 * Getter for <code>public.case.judge_assistant_phone</code>.
	 */
	...
	/**
	 * Setter for <code>public.case.add_user</code>.
	 */
	...
	/**
	 * Getter for <code>public.case.add_user</code>.
	 */
	 ...
	 */
	@Override
	public Row15<Integer, String, String, Integer, String, Date, Integer, String, Integer, Date, String, String, Integer, Integer, Integer> fieldsRow() {
	 ...
	 */
	@Override
	public Row15<Integer, String, String, Integer, String, Date, Integer, String, Integer, Date, String, String, Integer, Integer, Integer> valuesRow() {
	...
	public Field<String> field5() {
		return Case.CASE.JUDGE_ASSISTANT_PHONE;
	}
	 ...
	 */
	@Override
	public CaseRecord value5(String value) {
		setJudgeAssistantPhone(value);
		return this;
	}
	 ...
	 */
	@Override
	public CaseRecord value6(Date value) {
	 ...
	 */
	@Override
	public CaseRecord value7(Integer value) {
	 ...
	 */
	@Override
	public CaseRecord value8(String value) {
	 ...
	 */
	@Override
	public CaseRecord value10(Date value) {
	 ...
	 */
	@Override
	public CaseRecord value15(Integer value) {
	 ...
	 */
	@Override
	public CaseRecord values(Integer value1, String value2, String value3, Integer value4, String value5, Date value6, Integer value7, String value8, Integer value9, Date value10, String value11, String value12, Integer value13, Integer value14, Integer value15) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public CaseRecord(Integer caseId, String name, String number, Integer judgeId, String judgeAssistantPhone, Date caseStartDate, Integer litigationSubjectId, String litigationDescription, Integer endResultId, Date caseEndDate, String note, String addUser, Integer courtId, Integer statusId, Integer courtInstanceId) {
		super(Case.CASE);
		...
		setValue(2, number);
		setValue(3, judgeId);
		setValue(4, judgeAssistantPhone);
		setValue(5, caseStartDate);
		setValue(6, litigationSubjectId);
		setValue(7, litigationDescription);
		setValue(8, endResultId);
		setValue(9, caseEndDate);
		setValue(10, note);
		setValue(11, addUser);
		setValue(12, courtId);
		setValue(13, statusId);
		setValue(14, courtInstanceId);
	}
}
