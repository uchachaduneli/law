...
public class CaseRecord extends UpdatableRecordImpl<CaseRecord> implements Record15<Integer, String, String, Integer, Date, Integer, String, Integer, Date, String, Integer, Integer, Integer, Integer, Double> {

	private static final long serialVersionUID = 1873532639;
	 ...
	 */
	@Override
	public Row15<Integer, String, String, Integer, Date, Integer, String, Integer, Date, String, Integer, Integer, Integer, Integer, Double> fieldsRow() {
	 ...
	 */
	@Override
	public Row15<Integer, String, String, Integer, Date, Integer, String, Integer, Date, String, Integer, Integer, Integer, Integer, Double> valuesRow() {
	 ...
	 */
	@Override
	public CaseRecord values(Integer value1, String value2, String value3, Integer value4, Date value5, Integer value6, String value7, Integer value8, Date value9, String value10, Integer value11, Integer value12, Integer value13, Integer value14, Double value15) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public CaseRecord(Integer caseId, String name, String number, Integer judgeId, Date caseStartDate, Integer litigationSubjectId, String litigationDescription, Integer endResultId, Date caseEndDate, String note, Integer courtId, Integer statusId, Integer courtInstanceId, Integer addUserId, Double litigationPrice) {
		super(Case.CASE);
