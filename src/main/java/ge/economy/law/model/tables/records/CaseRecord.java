...
public class CaseRecord extends UpdatableRecordImpl<CaseRecord> implements Record14<Integer, String, String, Integer, Date, Integer, String, Integer, Date, String, String, Integer, Integer, Integer> {

    private static final long serialVersionUID = 1992479643;
	 ...
	 */
	@Override
    public Row14<Integer, String, String, Integer, Date, Integer, String, Integer, Date, String, String, Integer, Integer, Integer> fieldsRow() {
	 ...
	 */
	@Override
    public Row14<Integer, String, String, Integer, Date, Integer, String, Integer, Date, String, String, Integer, Integer, Integer> valuesRow() {
	 ...
	 */
    public CaseRecord(Integer caseId, String name, String number, Integer judgeId, Date caseStartDate, Integer litigationSubjectId, String litigationDescription, Integer endResultId, Date caseEndDate, String note, String addUser, Integer courtId, Integer statusId, Integer courtInstanceId) {
        super(Case.CASE);
